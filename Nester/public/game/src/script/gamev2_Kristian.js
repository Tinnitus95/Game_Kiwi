...
function startMap () {
    loadGame();
    //var myPos = navigator.geolocation.getCurrentPosition(loadGame);
}

function snatchNest(m, p) {
    alert('Hej');
    //marker = JSON.parse(m);
    //console.log(checkNestProximity(nestMarkers[m]));
    console.log(nestMarkers[m]);
...
/*             content: `
        ...
        console.log(nestMarkers.length);
